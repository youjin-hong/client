...
export const TechnicalFeatures = () => {
  ...
  return (
    <section id="technical-features" className="relative py-32 md:py-40" ref={containerRef}>
      <div className="max-w-[1120px] mx-auto px-5 md:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-sm md:text-base text-neutral-600 max-w-3xl mx-auto leading-relaxed">
            코드 기반 자동화의 한계를 넘어, Figma 디자인 데이터를 직접 활용하여 UI/UX를 종합적으로 검증합니다. YOLO,
            OCR, LLM을 결합한 AI 분석으로 시각적 컴포넌트부터 사용자 경험까지 자동으로 평가합니다.
          </p>
        </div>
                      ...
                      <td className="py-2 px-2 text-center align-middle">
                        <div className="flex flex-col items-center gap-1">
                          ...
                          {Array.isArray(row.existing) ? (
                            ...
                            <span className="text-neutral-700 text-sm leading-tight break-words max-w-[140px]">
                              {row.existing}
                            </span>
                          )}
                        </div>
                      ...
                      <td className="py-2 px-2 text-center align-middle">
                        <div className="flex flex-col items-center gap-1">
                          ...
                          {Array.isArray(row.auta) ? (
                            ...
                            <span className="text-neutral-900 font-medium text-sm leading-tight break-words max-w-[180px]">
                              {row.auta}
                            </span>
                          )}
                        </div>
          ...
          <div className="space-y-4 flex flex-col h-full">
            ...
            <GlassCard
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-neutral-900">UI 테스트</h3>
                  <p className="text-xs text-neutral-600">화면·컴포넌트 일치 검증</p>
                </div>
              </div>
              <ul className="space-y-2.5 text-sm text-neutral-700 mb-4">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Routing</strong> (화면 이동)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#5CA585] mt-1 font-bold">•</span>
                  <span>
                    <strong>Interaction</strong> (버튼·내비 등 상호작용)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#5CA585] mt-1 font-bold">•</span>
                  <span>
                    <strong>Component Matching</strong> (컴포넌트 매칭)
                  </span>
                </li>
              </ul>
            ...
            <GlassCard
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-neutral-900">UX 테스트</h3>
                  <p className="text-xs text-neutral-600">휴리스틱 경험 분석 포함</p>
                </div>
              </div>
              <div className="space-y-3 text-sm text-neutral-700">
                <p className="leading-relaxed">
                  AUTA는 Figma 레이아웃과 시각적 정보를 LLM에 입력하여 <strong>Nielsen 10원칙</strong> 기준의 위반
                  가능성을 탐지합니다.
                </p>
                <p className="leading-relaxed">
        ...
        <GlassCard
          ...
          <div className="space-y-4 text-sm text-neutral-700 leading-relaxed">
            <p>
              <strong>AUTA는 Figma 프로토타입의 인터랙션 정보를 직접 해석</strong>하여 한 개의 홈페이지 URL만으로 UI
              테스트 탐색을 수행합니다.
            </p>
            <p>
              별도의 스크립트 작성 없이도 디자인 상의 숨은 상태(hover, 뒤로 가기, 오버레이)를 그대로 재현하며, 실제
              화면의 설계 환경을 자동으로 탐색·검증할 수 있습니다.
            </p>
          </div>
        </GlassCard>
      </div>
