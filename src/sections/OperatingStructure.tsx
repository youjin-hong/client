...
export const OperatingStructure = () => {
  ...
  return (
    <section id="operating-structure" className="relative py-32 md:py-40" ref={containerRef}>
      <div className="max-w-[1120px] mx-auto px-5 md:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-sm md:text-base text-neutral-600 max-w-2xl mx-auto leading-relaxed">
            Figma 디자인 데이터를 자동으로 추출하고, AI 기반 분석을 통해 실제 구현 화면과 비교하여 불일치를 즉시
            발견합니다. 모든 과정이 자동화되어 수동 작업 없이도 정확한 검증이 가능합니다.
          </p>
        </div>
              ...
              <div key={idx} className="relative">
                <GlassCard
                  ...
                  <div className="space-y-3">
                    <p className="text-base text-neutral-700 leading-relaxed font-medium">{item.text}</p>

                    {/* 상세 설명 추가 */}
                    {idx === 0 && (
                      <div className="pt-3 border-t border-neutral-200">
                        <p className="text-sm text-neutral-600 leading-relaxed">
                          Figma 플러그인을 통해 현재 페이지의 모든 프레임을{' '}
                          <strong className="text-neutral-900">JSON 형식으로 내보냅니다</strong>. 디자이너가 작업한 원본
                          디자인 데이터가 그대로 테스트 기준이 됩니다.
                        </p>
                      </div>
                    )}
                    ...
                    {idx === 1 && (
                      <div className="pt-3 border-t border-neutral-200">
                        <p className="text-sm text-neutral-600 leading-relaxed">
                          <strong className="text-neutral-900">YOLO 모델</strong>로 UI 컴포넌트를 탐지하고,{' '}
                          <strong className="text-neutral-900">OCR 기술</strong>로 텍스트를 추출합니다. 추출된 JSON
                          데이터를 분석하여 실제 화면과 비교할 준비를 합니다.
                        </p>
                      </div>
                    )}
                    ...
                    {idx === 2 && (
                      <div className="pt-3 border-t border-neutral-200">
                        <p className="text-sm text-neutral-600 leading-relaxed">
                          발견된 불일치 항목을 <strong className="text-neutral-900">시각적 리포트</strong>로 저장합니다.
                          각 오류는 증거 캡처와 함께 저장되어, 팀원들이 쉽게 확인하고 수정할 수 있습니다.
                        </p>
                      </div>
                    )}
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-sm text-neutral-700 leading-relaxed">
                Figma에서 디자인 데이터를 추출하는 순간부터 오류 탐지까지, 모든 과정이 <strong>완전 자동화</strong>되어
                있습니다. 수동 작업 없이도 정확한 검증이 가능합니다.
              </p>
            </div>
            <div>
              <h4 className="text-lg font-bold text-neutral-900 mb-3 flex items-center gap-2">
              ...
              <p className="text-sm text-neutral-700 leading-relaxed">
                테스트가 진행되는 동안 <strong>실시간으로 진행 상황</strong>을 확인할 수 있으며, 완료 즉시 상세한
                리포트를 받아볼 수 있습니다.
              </p>
            </div>
          </div>
